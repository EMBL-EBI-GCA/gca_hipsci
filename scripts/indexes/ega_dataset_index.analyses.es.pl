...
foreach my $dataset_id (@dataset_id) {
  ...
  while (my $row = $sth_analysis->fetchrow_hashref) {
    ...
    # $VAR1 = 'HPSI1013i-aetc_1-exomeseq-ERZ117512';
    # $VAR1 = 'HPSI1013i-funy_1-exomeseq-ERZ117514';
    # $VAR1 = 'HPSI0913i-gooj_1-exomeseq-ERZ117515';
    # $VAR1 = 'HPSI1013i-aetc_1-exomeseq-ERZ117516';
    # $VAR1 = 'HPSI1013i-funy_1-exomeseq-ERZ117519';
    # $VAR1 = 'EGAD00001004295';
    # $VAR1 = 'EGAD00001003514';
    # $VAR1 = 'HPSI0513pf-oogu-exomeseq-ERZ267539';
    # $VAR1 = 'HPSI0613pf-vorx-exomeseq-ERZ267540';
    # $VAR1 = 'HPSI0513pf-golb-exomeseq-ERZ267541';
    # $VAR1 = 'HPSI0613pf-xavk-exomeseq-ERZ267542';
    # $VAR1 = 'HPSI0713pf-cicb-exomeseq-ERZ267543';
    # $VAR1 = 'HPSI0713i-terl_1-exomeseq-ERZ267544';


    $docs{$es_id} = {   #  'EGAD00001003514' this is the id
    ...
    #     };
print Dumper($docs['HPSI0513pf-oogu-exomeseq-ERZ267539']);
}
