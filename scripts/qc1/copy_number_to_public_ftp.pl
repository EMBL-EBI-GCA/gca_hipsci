...
my $copy_num_dir = '/nfs/research1/hipsci/drop/hip-drop/incoming/keane/hipsci_data_030517/plots/copy_number';
...
$GCA_HIPSCI/scripts/qc1/copy_number_to_public_ftp.pl
...
perl copy_number_to_public_ftp.pl -copy_number_dir=/path/to/plots/copy_number > actions.txt

=head1 OPTIONS

  -copy_number_dir: this must be the full path to a directory in Hinxton created by WTSI, usually called "plots/copy_number"
