...
&GetOptions(
    ...
    'aberrant_polysomy_dir=s'   => \$aberrant_polysomy_dir,
);
...
$GCA_HIPSCI/scripts/qc1/aberrant_polysomy_to_public_ftp.pl
...
perl aberrant_polysomy_to_public_ftp.pl -aberrant_polysomy_dir=/path/to/plots/aberrant_polysomy > actions.txt

=head1 OPTIONS

  -aberrant_polysomy_dir: this must be the full path to a directory in Hinxton created by WTSI, usually called "plots/aberrant_polysomy"
