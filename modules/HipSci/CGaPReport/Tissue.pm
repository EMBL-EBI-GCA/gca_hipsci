...
HipSci::CGaPReport::Tissue

=cut

package HipSci::CGaPReport::Tissue;
...
my %aliases = (
  ...
  passage_primary_firbroblast => 'dp_passage_primary_firbroblast',
  freeze_primary_firbroblast => 'dp_freeze_primary_firbroblast',
...
has 'ips_lines' => (
  is => 'rw',
  isa => 'ArrayRef[HipSci::CGaPReport::IPSLine]',
  default => sub {[]},
  lazy => 1,
);
