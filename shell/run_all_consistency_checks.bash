...
(
perl $HIPSCI_CODE/scripts/cgap_reports/consistency_checks/group_is_updating.pl SAMEG301470

perl $HIPSCI_CODE/scripts/cgap_reports/consistency_checks/biosample_present_in_cgap_report.pl SAMEG301470 | head

perl $HIPSCI_CODE/scripts/cgap_reports/consistency_checks/cell_line_is_in_biosamples.pl SAMEG301470 | head
