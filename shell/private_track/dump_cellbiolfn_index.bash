...
&& mv -f cellbiol-fn.$datestamp.index /nfs/research2/hipsci/drop/hip-drop/tracked/cellbiol-fn/ \
&& perl $RESEQTRACK/scripts/file/load_files.pl  \
  ...
  -file /nfs/research2/hipsci/drop/hip-drop/tracked/cellbiol-fn/cellbiol-fn.$datestamp.index \
