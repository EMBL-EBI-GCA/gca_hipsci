...
&& mv -f proteomics.maxquant.$datestamp.index /nfs/research1/hipsci/drop/hip-drop/tracked/proteomics \
&& perl $RESEQTRACK/scripts/file/load_files.pl  \
  ...
  -file /nfs/research1/hipsci/drop/hip-drop/tracked/proteomics/proteomics.maxquant.$datestamp.index \
